...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-NNM5E2QQ.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-RZMOZT6Q.js"), act = await getAct();
...
//# sourceMappingURL=chunk-U2OHGEMP.js.map
